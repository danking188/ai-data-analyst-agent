...
| LLM-P2 | [ ] | 对话式分析与受约束规划 | 多轮会话、只读工具、分析计划、Job、取消和重试端到端贯通 |
| LLM-P3 | [ ] | 清洗、分析与建模 Copilot | 可生成可编辑草案；执行、高成本或版本变更操作必须显式确认 |
| LLM-P4 | [ ] | 受控自主分析与生产强化 | 多步执行受工具白名单、Token/调用预算、熔断、审计和安全评估约束 |
