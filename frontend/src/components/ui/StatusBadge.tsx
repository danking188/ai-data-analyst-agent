...
const statusMap = {
  ...
  processing: { label: "处理中", tone: "warning", icon: LoaderCircle },
  ...
  awaiting_confirmation: { label: "待确认", tone: "warning", icon: ShieldAlert },
  proposed: { label: "待确认", tone: "warning", icon: ShieldAlert },
  approved: { label: "已批准", tone: "info", icon: CheckCircle2 },
  rejected: { label: "已拒绝", tone: "neutral", icon: Ban },
